...
/**
 * Holds information about their customer and allows them to apply for a loan. The actual work for the loan is handled by cpsc2150.mortgages.IMortgage
 ...
 *          Name: cpsc2150.mortgages.Customer must have a name
 *
 * Initialization Ensures: cpsc2150.mortgages.Customer will have a Name, a CreditScore, MonthlyDebt, and Income
...
public interface ICustomer {
     ...
     * @pre 0 <= downPayment < houseCost and houseCost > 0 and cpsc2150.mortgages.IMortgage.MIN_YEARS <= y <= cpsc2150.mortgages.IMortgage.MAX_YEARS
    ...
    /**
     *
     * @return the cpsc2150.mortgages.Customer's name
     * @post getName = Name
     */
    String getName();
